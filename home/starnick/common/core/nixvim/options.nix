{
  programs.nixvim = {
    ...
    opts = {
      ...
      hidden = true; # Keep closed buffer open in the background NOTE: not sure yet
      mouse = "a"; # Enable mouse control
      # mousemodel = "extend"; # Mouse right-click extends the current selection NOTE: not sure yet
      ...
      wrap = false; # Prevent text from wrapping NOTE: maybe need this on true
